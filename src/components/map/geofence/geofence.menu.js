        ...
        <div className="fence-body flex-full">
          {
            this.state.geofenceAll.map(function (fence, index) {
              return <Card key={fence.id} title={fence.area_name} onClick={() => highLightFence(fence)}
                ...
                <div className="action-list">
                  <div className="item">
                    <Button shape='circle' icon='delete' className='btn-delete' onClick={() => deleteGeofence(fence)}/>
                  </div>
                  <div className="item">
                    <Link to={`/geofence/id/${fence.id}`}><Button shape='circle' icon='edit' className='btn-edit'
